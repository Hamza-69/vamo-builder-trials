    ...
    Tables: {
      ...
      listings: {
        Row: {
          ...
          description: string | null
          id: string
          last_timeline_item_id: string | null
          metrics: Json | null
          project_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "listings_last_timeline_item_id_fkey"
            columns: ["last_timeline_item_id"]
            isOneToOne: false
      ...
      reward_ledger: {
        ...
        Relationships: [
          {
            foreignKeyName: "reward_ledger_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
